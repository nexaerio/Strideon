...
class STextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle()
        .copyWith(fontSize: SSizes.fontSizeMd, color: SColors.grey),
    hintStyle: const TextStyle()
        .copyWith(fontSize: SSizes.fontSizeSm, color: SColors.darkGrey),
    errorStyle: const TextStyle().copyWith(fontStyle: FontStyle.normal),
    floatingLabelStyle:
        const TextStyle().copyWith(color: SColors.grey.withOpacity(0.8)),
    ...
    focusedBorder: const OutlineInputBorder().copyWith(
      borderRadius: BorderRadius.circular(SSizes.inputFieldRadius),
      borderSide: const BorderSide(width: 1, color: SColors.spalette),
    ),
